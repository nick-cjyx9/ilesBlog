<template layout="base">
    <div class="holder w-full min-h-[500px] p-8">
        <form class="w-full mx-auto" id="searchForm">
            ...
            <div class="relative">
                ...
                <button type="submit"
                    class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
            </div>
        </form>
    ...
    <!-- tailwind -->
    <div class="hidden px-4 break-all h-[100px] overflow-hidden text-ellipsis"></div>
    <li class="hidden w-full text-minor-link px-3 py-1" role="button"><a class="w-full"><span
...
fetch('/fuse/data.json').then(fresponse => { return fresponse.json() }).then(list => {
