...
<template>
  <div id="btnContainer" ref="a" class="fixed right-5 space-y-1 flex flex-col">
    <a role="button" class="w-10 h-10 font-bold holder border-2 border-black dark:border-white dark:text-white flex items-center justify-center rounded-full" @click="toTop">
    ...
    <a id="expandToc" ref="b" role="button" class="font-bold border-2 border-black dark:border-white w-10 h-10 holder dark:text-white items-center justify-center rounded-full flex opacity-0">
