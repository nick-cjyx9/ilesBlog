...
<template>
  <div id="btnContainer" ref="a" class="md:hidden fixed right-6 space-y-[8px] flex flex-col z-50">
    <a role="button" class="w-10 h-10 font-bold holder border-[1px] border-zinc-600 dark:border-white dark:text-white flex items-center justify-center rounded-full" @click="toTop">
    ...
    <a id="expandToc" ref="b" role="button" class="font-bold border-[1px] border-zinc-600 dark:border-white w-10 h-10 holder dark:text-white items-center justify-center rounded-full flex opacity-0">
